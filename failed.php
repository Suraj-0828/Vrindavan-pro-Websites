...
<head>
 ...
 <!-- Header start -->
 <header id="sticky-header" id="home" class="relative bg-[#E8F1FF] lg:py-[20px] z-10 secondary-sticky secondary-sticky"
            style="z-index: 2000;">
            <div class="container">
                    ...
                    <div class="col-span-12">
                        <div class="flex flex-wrap items-center justify-between">
                            <a href="https://dhartidevelopers.co.in/vrindavan" class="block">
                                <img class="w-full h-full" src="assets/images/logoo/logo.png" loading="lazy" width="99"
                                    height="46" alt="brand logo">
                            </a>
                            <nav class="flex flex-wrap items-center">
                                <ul
                                    ...
                                    <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                        ...
                                        <a href="https://dhartidevelopers.co.in/vrindavan" style="font-size: 25px;"
                                            class="transition-all text-black hover:text-secondary">Home</a>
                                    ...
                                    <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                        ...
                                        <a href="https://dhartidevelopers.co.in/vrindavan" style="font-size: 25px;"
                                            class="transition-all text-black hover:text-secondary">About us</a>
                                    ...
                                    <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                        ...
                                        <a href="https://dhartidevelopers.co.in/vrindavan" style="font-size: 25px;"
                                            class="transition-all text-black hover:text-secondary">Amenities</a>
                                    ...
                                    <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                        ...
                                        <a href="https://dhartidevelopers.co.in/vrindavan" style="font-size: 25px;"
                                            class="transition-all text-black hover:text-secondary">Near by</a>
                                    ...
                                    <li class="mr-7 xl:mr-[40px] relative group py-[20px]">
                                        ...
                                        <a href="https://dhartidevelopers.co.in/vrindavan" style="font-size: 25px;"
                                            class="transition-all text-black hover:text-secondary">Contact</a>
        ...
        <div style="z-index: 2000;" id="offcanvas-mobile-menu"
            ...
            <div class="py-12 pr-5 h-[100vh] overflow-y-auto">
                <img class="mr-auto" style="justify-content: center; margin: 0px 0px 15px 15px;"
                    src="assets/images/logoo/LOGO.png">
                <!-- close button start -->
                <button class="offcanvas-close text-black text-[25px] w-10 h-10 absolute right-0 top-0 z-[1]"
                ...
                <nav class="offcanvas-menu mr-[20px]">
                    <ul>
                        <li class="relative block border-b-black border-b first:border-t first:border-t-black">
                            <a href="https://dhartidevelopers.co.in/vrindavan"
                        ...
                        <li class="relative block border-b-primary border-b">
                            <a href="https://dhartidevelopers.co.in/vrindavanp"
                                class="block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5">About
                                us</a>
                        ...
                        <li class="relative block border-b-primary border-b">
                            <a href="https://dhartidevelopers.co.in/vrindavan"
                                class="block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5">Amenities</a>

                        </li>
                        <li class="relative block border-b-primary border-b"><a href="https://dhartidevelopers.co.in/vrindavan"
                                class="relative block capitalize font-normal text-black hover:text-secondary text-base my-2 py-1 px-5">Near
                                by</a>
                        </li>
...
<div class="">
    <h1 class="failed ">
   <img class="wrong" src="assets/images/other/wrong.png">SomeThing Worng...
    </h1>
</div>
<div class="">
    <div class="img-size">
  ...
  <footer class="footer bg-[#EEEEEE] pt-10 font-normal bg-no-repeat" style="background-image: url('assets/images/footer/pattern.png');">
          ...
          <div class="row">
              ...
              <div class="col-md-3 media-quick-link-padding">
                  ...
                  <ul class="leading-none ">
                      <li class="mb-[20px]"><a class="inline-block transition-all text-black hover:text-secondary" href="index.php">Home
                          </a></li>
                      <li class="mb-[20px]"><a class="inline-block transition-all text-black hover:text-secondary" href="index.php">About us</a></li>
                      <li class="mb-[20px]"><a class="inline-block transition-all text-black hover:text-secondary" href="index.php">Amenities</a></li>
                      <li class="mb-[20px]"><a class="inline-block transition-all text-black hover:text-secondary" href="index.php">Near by</a></li>
                      <li class="mb-[20px]"><a class="inline-block transition-all text-black hover:text-secondary" href="index.php">Contact</a></li>
                  </ul>
              </div>
              <div class="col-md-3">
                  <h3 class="font-lora font-normal text-[32px] leading-[1.222] text-black mb-[20px] lg:mb-[30px]">
      ...
      <div style="margin-bottom: -100px;" class="row text-center mr-auto mt-10">
          <div class="col-lg-12">
              <p class="text-sm text-center md:block ">&copy; <a href="https://themeforest.net/user/codecarnival/portfolio" class="text-secondary">CodeCarnival.</a> All Rights Reserved - Privacy Policy</p>
          </div>
      </div>
  </footer>
  <!-- Footer End -->
